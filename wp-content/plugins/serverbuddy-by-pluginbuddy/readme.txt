...
Contributors: dustinbolton
Tags: server, security, compatibility, plugin, pluginbuddy
Requires at least: 2.7
Tested up to: 3.1.3
Stable tag: 1.0.1

ServerBuddy by PluginBuddy.com provides various tools & tests to analyze server configuration & troubleshoot issues. Navigate to Tools: ServerBuddy to get started.
...
1. Full ServerBuddy page displaying most feautres.
