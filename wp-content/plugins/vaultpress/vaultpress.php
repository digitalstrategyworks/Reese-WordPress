...
define( 'VAULTPRESS_SHARED_KEY_INIT',   'djsMEuEDYvWqxrB' );
define( 'VAULTPRESS_SHARED_SECRET_INIT', 'XOdFj32H5O3ZlROpMCkfbsSrc3jkg24ILKEeUzLT5X' );
...
function vaultpress_activate() {
	if ( defined( 'VAULTPRESS_SHARED_KEY_INIT' ) && VAULTPRESS_SHARED_KEY_INIT )
		update_option( 'vaultpress_key', VAULTPRESS_SHARED_KEY_INIT );
	if ( defined( 'VAULTPRESS_SHARED_SECRET_INIT' ) && VAULTPRESS_SHARED_SECRET_INIT )
