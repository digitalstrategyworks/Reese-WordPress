...
<div id="mask"></div>
		...
		<div id="reese">
			<h1>Mobile.</h1>
			<p>Text your photos to us at 919.448.5405, or e-mail them to social@reesenews.org</p>
			<p>Watching this on the screen in Fetzer? Go to uncdm.reesenews.org to visit the site on your smartphone. Once you're there, check out the "Posts" tab to share photos with other dancers.</p>
			<p>Mobile coverage for this event provided by <a href="http://reesenews.org/" target="_blank">reesenews.org</a>. If you would like to have your event covered please <a href="mailto:social@reesenews.org">get in touch with us</a>.</p>
			<p><a href="http://reesenews.org/" target="_blank"><img src="<?php bloginfo('template_directory'); ?>/images/reesenews.png" /></a></p>
		</div>
