		...
		<ul id="gallery">
			<?php query_posts('showposts=1&category_name=wire-category-slider'); ?>
			 <?php while ( have_posts() ) : the_post(); ?>
				<li><a href="<?php the_permalink(); ?>"><img src="<?php if ( function_exists('the_DifferentTypeFacts') ) the_DifferentTypeFacts($post->ID, 'category-image'); ?>" /></a></li>
...
<div id="content" class="grid_16">
		...
		<div id="leftBar" class="grid_5">
			...
			<?php query_posts('showposts=6&category_name=wire-left'); ?>
			<?php while ( have_posts() ) : the_post(); ?>
			<?php global $post; ?>
		...
		<div id="featured_text" class="grid_11">
			...
			<!-- pulls a list of posts from category 'featured_text' into list items -->
			 ...
			 $myposts = get_posts('numberposts=3&offset=0&category_name=wire-featured-text');
		...
		<div id="middleBar" class="grid_7">
			...
			<?php query_posts('showposts=4&category_name=wire-middle'); ?>
			<?php while ( have_posts() ) : the_post(); ?>
			<?php global $post; ?>
