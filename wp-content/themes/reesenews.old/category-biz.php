...
<div id="content" class="grid_16">
	...
	<div id="categoryContent" class="grid_12">
			...
			<?php query_posts('showposts=1&category_name=biz-featured-category'); ?>
			...
			<div id="featuredContent">
				...
				<div id="featuredCaption">
					<a href="<?php the_permalink(); ?>"><span class="head"><?php the_title(); ?></span><br /><span class="subhead"><?php if ( function_exists('the_DifferentTypeFacts') ) the_DifferentTypeFacts($post->ID, 'subhead'); ?></span><span class="arrows">&gt;&gt;&gt;</span><span class="more">FULL STORY</span></a>
				</div>
		...
		<?php
			...
			query_posts("posts_per_page=5&paged=$paged&category_name=biz"); ?>
		<?php while(have_posts()): the_post(); ?>
		<?php global $post; ?>
