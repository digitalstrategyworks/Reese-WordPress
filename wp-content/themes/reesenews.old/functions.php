<?php
		...
		function widget($args, $instance) {
			...
			<?php
				...
				<div class="imageHolder">					
					...
					<div class="showAllButton"><div class="rss_button"><span><a href="<?php echo $category_link; ?>">U</a></span></div><div id="show-1"><div class="z-nav"></div><span class="more">more content</span></div></div>
					<div class="window"></div>
					<img class="rss" src="<?php bloginfo('template_directory'); ?>/images/rss.png" />
				</div>
		...
		function widget($args, $instance) {
			...
			<?php
				...
				<div class="imageHolder">					
					...
					<div class="showAllButton"><div class="rss_button"><span><a href="<?php echo $category_link; ?>">TOWN</a></span></div><div id="show-5"><div class="z-nav"></div><span class="more">more content</span></div></div>
					<div class="window"></div>
					<img class="rss" src="<?php bloginfo('template_directory'); ?>/images/rss.png" />
				</div>
		...
		function widget($args, $instance) {
			...
			<?php
				...
				<div class="imageHolder">					
					...
					<div class="showAllButton"><div class="rss_button"><span><a href="<?php echo $category_link; ?>">BIZ</a></span></div><div id="show-2"><div class="z-nav"></div><span class="more">more content</span></div></div>
					<div class="window"></div>
					<img class="rss" src="<?php bloginfo('template_directory'); ?>/images/rss.png" />
				</div>
		...
		function widget($args, $instance) {
			...
			<?php
				...
				<div class="imageHolder">					
					...
					<div class="showAllButton"><div class="rss_button"><span><a href="<?php echo $category_link; ?>">SPORT</a></span></div><div id="show-6"><div class="z-nav"></div><span class="more">more content</span></div></div>
					<div class="window"></div>
					<img class="rss" src="<?php bloginfo('template_directory'); ?>/images/rss.png" />
				</div>
		...
		function widget($args, $instance) {
			...
			<?php
				...
				<div class="imageHolder">					
					...
					<div class="showAllButton"><div class="rss_button"><span><a href="<?php echo $category_link; ?>">CHill</a></span></div><div id="show-3"><div class="z-nav"></div><span class="more">more content</span></div></div>
					<div class="window"></div>
					<img class="rss" src="<?php bloginfo('template_directory'); ?>/images/rss.png" />
				</div>
				<?php endwhile; ?>
		...
		function widget($args, $instance) {
			...
			<?php
				...
				<div class="imageHolder">					
					...
					<div class="showAllButton"><div class="rss_button"><span><a href="<?php echo $category_link; ?>">CHill</a></span></div><div id="show-4"><div class="z-nav"></div><span class="more">more content</span></div></div>
					<div class="window"></div>
					<img class="rss" src="<?php bloginfo('template_directory'); ?>/images/rss.png" />
				</div>
				<?php endwhile; ?>
		...
		function widget($args, $instance) {
			...
			<?php
				...
				<div class="imageHolder">					
					...
					<div class="showAllButton"><div class="rss_button"><span><a href="<?php echo $category_link; ?>">CHill</a></span></div><div id="show-7"><div class="z-nav"></div><span class="more">more content</span></div></div>
					<div class="window"></div>
					<img class="rss" src="<?php bloginfo('template_directory'); ?>/images/rss.png" />
				</div>
				<?php endwhile; ?>
	...
	function the_breadcrumb() {
		...
		echo 'Reesenews';
		echo '</span></a><span class="orange raq"> &raquo; </span>';
		
		if (is_category() || is_single() ) {
			$category_to_link = get_category_header();
			if ( $category_to_link != 'news' ) {
				$category_id = get_cat_ID($category_to_link);
				$category_link = get_category_link($category_id);
				echo '<a href="' . $category_link . '"><span class="red">';
				echo get_category_header();
				echo '</span></a>';
				if ( is_single() ) {
					//don't do anything for now
					echo '<span class="red raq"> &raquo; </span>';
				}
			}
		}
	}
